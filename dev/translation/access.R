...
laval_dict <- tibble::tibble(var = "parc", title = "Parc", short = "Parc")
laval_dict <- tibble::add_row(laval_dict, var = "patinoire_exterieure", title = "Patinoires extérieures", short = "Patinoires")
laval_dict <- tibble::add_row(laval_dict, var = "centre_communautaire", title = "Centres communautaires", short = "Centres")
laval_dict <- tibble::add_row(laval_dict, var = "poste_de_police_de_quartier", title = "Postes de police de quartier", short = "Police")
laval_dict <- tibble::add_row(laval_dict, var = "piscine_exterieure", title = "Piscines extérieures", short = "Piscines")
laval_dict <- tibble::add_row(laval_dict, var = "piscine_interieure", title = "Piscines extérieures", short = "Piscines")
laval_dict <- tibble::add_row(laval_dict, var = "edifice_municipal", title = "Édifices municipales", short = "Édifices")
laval_dict <- tibble::add_row(laval_dict, var = "station_de_metro", title = "Stations de métro", short = "Métro")
laval_dict <- tibble::add_row(laval_dict, var = "centre_sportif", title = "Centres sportifs", short = "Sports")
laval_dict <- tibble::add_row(laval_dict, var = "salle_de_spectacle", title = "Salles de spectacle", short = "Spectacles")
laval_dict <- tibble::add_row(laval_dict, var = "centres_et_galeries_dart", title = "Centres et galeries d'art", short = "Art")
laval_dict <- tibble::add_row(laval_dict, var = "belvedere", title = "Belvédères", short = "Belvédères")
laval_dict <- tibble::add_row(laval_dict, var = "bureau_municipal_lavallois", title = "Bureaux municipaux de Laval", short = "Bureaux")
laval_dict <- tibble::add_row(laval_dict, var = "halte", title = "Haltes", short = "Haltes")
laval_dict <- tibble::add_row(laval_dict, var = "autres", title = "Autres", short = "Autres")
laval_dict <- tibble::add_row(laval_dict, var = "bibliotheque", title = "Bibliothèques", short = "Bibliothèques")
laval_dict <- tibble::add_row(laval_dict, var = "gare", title = "Gares", short = "Gares")
laval_dict <- tibble::add_row(laval_dict, var = "arena", title = "Arénas", short = "Arénas")
laval_dict <- tibble::add_row(laval_dict, var = "berge", title = "Berges", short = "Berges")
laval_dict <- tibble::add_row(laval_dict, var = "caserne_de_pompiers", title = "Casernes de pompiers", short = "Casernes")
laval_dict <- tibble::add_row(laval_dict, var = "jeux_deau", title = "Jeux d'eau", short = "Eau")
laval_dict <- tibble::add_row(laval_dict, var = "bois", title = "Bois", short = "Bois")

dict <- dplyr::bind_rows(cc.data::accessibility_point_dict, laval_dict,
                         tibble::tibble(var = "daycare", title = "Daycare spots", short = "Daycare"))
...
# Laval
translation_access <- rbind(translation_access,
                            tibble::tibble(en = c(laval_dict$title, laval_dict$short),
                                           fr = c(laval_dict$title, laval_dict$short))) |>
  unique()
