...
translation_df <-
  ...
  add_row(en = "former municipality",
          fr = "ancienne municipalité") |>
  add_row(en = "the Laval Sector",
          fr = "le Secteur d'aménagement") |>
  add_row(en = "the former municipality",
          fr = "l'ancienne municipalité") |>
  add_row(en = "Laval Sectors",
          fr = "Secteurs d'aménagement") |>
  add_row(en = "former municipalities",
          fr = "anciennes municipalités") |>
  add_row(en = "Former municipality",
         fr = "Ancienne municipalité") |>
  add_row(en = "Laval Sector of {name}",
          fr = "Secteur d'aménagement {name}") |>
  add_row(en = "Former municipality of {name}",
          fr = "Ancienne municipalité {name}") |>
  add_row(en = "Delimitation of Ville de Laval's development sectors. Development sectors serve the various territorial management needs of Ville de Laval.",
          fr = "Délimitation des secteurs d'aménagement de la Ville de Laval. Les secteurs d'aménagement servent aux divers besoins de gestion territoriale de la Ville de Laval.") |>
  add_row(en = "Delineation of the former municipalities before the 1965 merger to form what is now Ville de Laval.",
          fr = "Délimitation des anciennes municipalités avant la fusion de 1965 pour constituer ce qui est aujourd'hui la Ville de Laval.") |>
  add_row(en = "City of Laval",
          fr = "Ville de Laval") |>
  add_row(en = "Ville de Laval",
          fr = "Ville de Laval") |>
  add_row(en = "in the City of Laval",
          fr = "dans la ville de Laval") |>
  add_row(en = "the City of Laval",
          fr = "la ville de Laval") |>
  add_row(en = "Access to lieux et édifices municipaux",
          fr = "Accès aux lieux et édifices municipaux") |>
